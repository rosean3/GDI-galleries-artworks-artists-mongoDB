...
db.obras.insertMany([
    {
      ...
      },
      {
        ...
        preco: 2914.43,
        id_obra: "pin_07",
        artistas_id: [db.artistas.findOne({id_artista:"art_08"})._id, db.artistas.findOne({id_artista:"art_09"})._id]
      },
      {
        ...
        preco: 2128.45,
        id_obra: "esc_03",
        artistas_id: [db.artistas.findOne({id_artista:"art_02"})._id, db.artistas.findOne({id_artista:"art_04"})._id]
      },
      {
