...
db.galerias.insertMany([
  {
    ...
    obras_id: [
      db.obras.findOne({ id_obra: "ins_02" }),
      db.obras.findOne({ id_obra: "esc_00" }),
      db.obras.findOne({ id_obra: "esc_03" }),
      db.obras.findOne({ id_obra: "ins_00" }),
      db.obras.findOne({ id_obra: "pin_07" }),
      db.obras.findOne({ id_obra: "pin_03" }),
      db.obras.findOne({ id_obra: "pin_06" }),
    ],
  },
  {
  ...
  },
  {
    ...
    obras_id: [
      db.obras.findOne({ id_obra: "esc_01" }),
      db.obras.findOne({ id_obra: "esc_02" }),
      db.obras.findOne({ id_obra: "esc_03" }),
      db.obras.findOne({ id_obra: "ins_02" }),
    ],
  },
  {
    ...
    obras_id: [
      db.obras.findOne({ id_obra: "pin_05" }),
      db.obras.findOne({ id_obra: "pin_04" }),
      db.obras.findOne({ id_obra: "pin_07" }),
      db.obras.findOne({ id_obra: "esc_01" }),
    ],
  },
  {
    ...
    obras_id: [
      db.obras.findOne({ id_obra: "pin_00" }),
      db.obras.findOne({ id_obra: "pin_01" }),
      db.obras.findOne({ id_obra: "pin_02" }),
      db.obras.findOne({ id_obra: "ins_01" }),
      db.obras.findOne({ id_obra: "pin_04" }),
    ],
  },
  {
